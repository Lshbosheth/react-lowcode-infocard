            ...
            {config.actions.map(action => (
                ...
                >
                    ...
                    <div>
                        ...
                        <select
                            value={action.type}
                            onChange={(e) => handleUpdateAction(action.id, { type: e.target.value as InfoCardAction["type"] })}
                            style={{
                                width: "100%",
                                padding: "4px 8px",
                                border: "1px solid #d9d9d9",
                    ...
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) => handleUpdateAction(action.id, { clickAction: e.target.value as InfoCardAction["clickAction"] })}
                            style={{
                                width: "100%",
                                padding: "4px 8px",
                                border: "1px solid #d9d9d9",
